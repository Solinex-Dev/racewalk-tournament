 ...
 * No cron jobs; effective status is derived from timestamps during system operations.
 */
 ...
 */
export function resolveUserStatus(user: UserWithStatus): ResolvedUserStatus {
 ...
 * revokes all UserSessions. Atomic via transaction.
 */
