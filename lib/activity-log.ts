...
export const ActivityLogAction = {
  ...
  AFFILIATIONS_BULK_IMPORTED: "AFFILIATIONS_BULK_IMPORTED",
  // Root-admin CSV export
  ATHLETES_EXPORTED: "ATHLETES_EXPORTED",
  JUDGES_EXPORTED: "JUDGES_EXPORTED",
  AFFILIATIONS_EXPORTED: "AFFILIATIONS_EXPORTED",
...
export function classifyOperation(action: string): ActivityOperation {
  ...
  if (a === "PAGE_VIEW" || /EXPORT/.test(a)) return "READ";
