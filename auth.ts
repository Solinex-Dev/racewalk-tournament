 ...
 * Session list/revoke via UserSession table keyed by sessionId in JWT.
 *
 * Ported from Judtang. Adaptations for Racewalk:
 * - Turnstile (Cloudflare captcha) removed — can be re-added later if needed
 * - Sign-in page mounted at /admin/login (Racewalk has admin-only password auth)
 */
